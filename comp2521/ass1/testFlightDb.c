...
static void testDbCreateAndFree(void);
static void testDbInsertSingleRecord(void);
...
int main(int argc, char *argv[]) {
    ...
    switch (atoi(argv[1])) {
        ...
        case 10: testDbCreateAndFree();             break;
        case 11: testDbInsertSingleRecord();        break;
        default:
...
static void testDbCreateAndFree(void) {
    ...
    printf("Testing DbCreateAndFree\n");
    printf("Simply creates a new FlightDb and frees it\n\n");

    FlightDb db = DbNew();
    DbFree(db);
    printf("The record was freed\n");
...
static void testDbInsertSingleRecord(void) {
    ...
    printf("Testing DbInsertSingleRecord\n\n");
